	...
	_createClass(Keyboard, [{
		...
		value: function renderKeyRows() {
			...
			return keys.map(function (row, i) {
				return _react2.default.createElement('div', { className: 'keyboard-row', key: 'row-' + i }, i === keys.length - 1 && _react2.default.createElement(_KeyboardButton2.default, {
		...
		value: function renderNumeric() {
			...
			return _react2.default.createElement('div', { className: 'keyboard numeric-keyboard' }, keys.map(function (row, i) {
				return _react2.default.createElement('div', { className: 'keyboard-row', key: 'row-' + i }, row.map(function (button) {
					return _react2.default.createElement(_KeyboardButton2.default, {
						value: button,
			...
			}), _react2.default.createElement('div', { className: 'keyboard-row' }, leftButtons, rightButtons));
		}
	}, {
		...
		value: function renderAlphanumeric() {
			...
			return _react2.default.createElement('div', { className: 'keyboard' }, _react2.default.createElement('div', { className: 'keyboard-row' }, numbers.map(function (button) {
				return _react2.default.createElement(_KeyboardButton2.default, {
					value: button,
			...
			})), this.renderKeyRows(), _react2.default.createElement('div', { className: 'keyboard-row' }, leftButtons, this.props.layouts.length > 1 ? _react2.default.createElement(_KeyboardButton2.default, {
			...
			}) : null, _react2.default.createElement(_KeyboardButton2.default, {
				value: ' ',

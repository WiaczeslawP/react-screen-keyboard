...
Keyboard.propTypes = {
	...
	layouts: _react.PropTypes.arrayOf(_react.PropTypes.shape({
		...
		layout: _react.PropTypes.oneOfType([_react.PropTypes.arrayOf(_react.PropTypes.arrayOf(_react.PropTypes.string)), _react.PropTypes.arrayOf(_react.PropTypes.string)])
	}))
};
